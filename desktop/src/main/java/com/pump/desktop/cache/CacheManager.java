 ...
 * @(#)CacheManager.java
 *
 * $Date: 2016-06-20 19:59:58 +0500 (Mon, 20 Jun 2016) $
 *
...
public class CacheManager {
	 ...
	 * 
	 * @param appName
	 * @param version this optional version name will be used to create a version-specific folder within
	 * the cache.
	 * If this is non-null: then all inactive directories (from previous versions) will be deleted.
	 * @throws IOException
	 */
	 ...
	 * to the version this CacheManager was initialized/constructed with. (So if this
	 * was constructed with a null version, this scenario returns a null file.)
	 ...
	 * be null (unless you asked for the versioned dir but didn't construct
	 * this object with a version), but it may be empty (either the user/system may choose to clear it,
	...
	/**
	 * Uncache an object previously cached by 
	 * calling {@link #cache(Object, File)}.
	 * 
	 * @param cachedObject the file to uncache.
	 */
	public static Object uncache(File cachedObject) throws IOException, ClassNotFoundException
	{
	 ...
	 * 
	 * @param object a Serializable object to cache.
	 * @param dest the File destination to write to.
	 */
	public static void cache(Object object, File dest) throws IOException
	{
		if(!dest.exists())
			if(!dest.createNewFile())
				throw new IOException("createNewFile() failed for "+dest.getAbsolutePath());
