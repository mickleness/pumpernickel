 ...
 * <table summary="Resource&#160;Samples&#160;for&#160;com.bric.plaf.VistaMultiThumbSliderUI"><tr>
 * <td>Thumb.Circle</td>
 * <td><img src="https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/VistaMultiThumbSliderUI/sample.png" alt="com.pump.plaf.DefaultMultiThumbSliderUI.createDemo(&#160;com.bric.plaf.VistaMultiThumbSliderUI.class,&#160;com.bric.plaf.MultiThumbSliderUI$Thumb.Circle&#160;)"></td>
 * </tr><tr>
 * <td>Thumb.Triangle</td>
 * <td><img src="https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/VistaMultiThumbSliderUI/sample2.png" alt="com.pump.plaf.DefaultMultiThumbSliderUI.createDemo(&#160;com.bric.plaf.VistaMultiThumbSliderUI.class,&#160;com.bric.plaf.MultiThumbSliderUI$Thumb.Triangle&#160;)"></td>
 * </tr><tr>
 * <td>Thumb.Rectangle</td>
 * <td><img src="https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/VistaMultiThumbSliderUI/sample3.png" alt="com.pump.plaf.DefaultMultiThumbSliderUI.createDemo(&#160;com.bric.plaf.VistaMultiThumbSliderUI.class,&#160;com.bric.plaf.MultiThumbSliderUI$Thumb.Rectangle&#160;)"></td>
 * </tr><tr>
 * <td>Thumb.Hourglass</td>
 * <td><img src="https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/VistaMultiThumbSliderUI/sample4.png" alt="com.pump.plaf.DefaultMultiThumbSliderUI.createDemo(&#160;com.bric.plaf.VistaMultiThumbSliderUI.class,&#160;com.bric.plaf.MultiThumbSliderUI$Thumb.Hourglass&#160;)"></td>
 * </tr><tr>
 * </tr></table>
...
@ResourceSample( 
		...
		sample= {
				"com.pump.plaf.DefaultMultiThumbSliderUI.createDemo( com.pump.plaf.VistaMultiThumbSliderUI.class, com.bric.plaf.MultiThumbSliderUI$Thumb.Circle )",
				"com.pump.plaf.DefaultMultiThumbSliderUI.createDemo( com.pump.plaf.VistaMultiThumbSliderUI.class, com.bric.plaf.MultiThumbSliderUI$Thumb.Triangle )",
				"com.pump.plaf.DefaultMultiThumbSliderUI.createDemo( com.pump.plaf.VistaMultiThumbSliderUI.class, com.bric.plaf.MultiThumbSliderUI$Thumb.Rectangle )",
				"com.pump.plaf.DefaultMultiThumbSliderUI.createDemo( com.pump.plaf.VistaMultiThumbSliderUI.class, com.bric.plaf.MultiThumbSliderUI$Thumb.Hourglass )" })
public class VistaMultiThumbSliderUI<T> extends DefaultMultiThumbSliderUI<T> {
	...
	protected void paintTrack(Graphics2D g) {
		...
		g.drawLine(trackRect.x, trackRect.y, trackRect.x+trackRect.width, trackRect.y);
		g.drawLine(trackRect.x, trackRect.y, trackRect.x, trackRect.y+trackRect.height);
		g.drawLine(trackRect.x+trackRect.width, trackRect.y, trackRect.x+trackRect.width, trackRect.y+trackRect.height);
		g.setPaint(new Color(255,255,255,16));
		g.drawLine(trackRect.x, trackRect.y+trackRect.height, trackRect.x+trackRect.width, trackRect.y+trackRect.height);
	...
	protected void paintThumb(Graphics2D g,int thumbIndex,float selected) {
		...
		if(!(Thumb.Rectangle.equals(getThumb(thumbIndex))
				|| Thumb.Hourglass.equals(getThumb(thumbIndex)))) {
