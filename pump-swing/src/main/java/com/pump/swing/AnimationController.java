...
public class AnimationController extends JPanel {
	 ...
	 * assigning the borders of all the components, assigning the PanelUI of
	 * the container, assigning the preferred size of the container, and
	 * making a spacebar on the slider trigger the toggle play button.
	 * 
	 * @param container this container is emptied, assigned a GridBagLayout, and
	 *   the other arguments are added to this container.
	 * @param togglePlayButton this button will be the left-most button. It is
	 *   expected to always be visible.
	 * @param buttons an optional collection of buttons to display after the
	 *   togglePlayButton.
	 * @param slider the slider that stretches to fill the remaining width.
	 */
	public static void format(JPanel container, final JButton togglePlayButton,
			JButton[] buttons, JSlider slider) {
		if(buttons==null)
			buttons = new JButton[] {};
		container.setUI(new GradientPanelUI(Color.lightGray, Color.white));
		container.removeAll();
