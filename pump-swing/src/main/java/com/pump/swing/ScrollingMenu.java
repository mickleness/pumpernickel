 ...
 * <p>
 * This is loosely based on/inspired by darrylbu.util.MenuScroller. I had trouble
 * sometimes with the placement of that popup menu, though, so this implementation
 * separates the JMenu (which has to constantly be revised as you scroll menu items)
...
public class ScrollingMenu
{
	...
	private static class CenteredTriangleIcon extends TriangleIcon {
		...
		public void paintIcon(Component c, Graphics g, int x, int y)
		{
			...
			super.paintIcon(c, g, d.width/2 - getIconWidth()/2, d.height/2 - getIconHeight()/2);
		}
		
	}
	
	public static final Icon ENABLED_UP_ICON = new CenteredTriangleIcon(SwingConstants.NORTH, 8, 8, Color.BLACK);
	public static final Icon DISABLED_UP_ICON = new CenteredTriangleIcon(SwingConstants.NORTH, 8, 8, Color.GRAY);
	public static final Icon ENABLED_DOWN_ICON = new CenteredTriangleIcon(SwingConstants.SOUTH, 8, 8, Color.BLACK);
	public static final Icon DISABLED_DOWN_ICON = new CenteredTriangleIcon(SwingConstants.SOUTH, 8, 8, Color.GRAY);
	...
	Runnable refreshMenuRunnable = new Runnable() {
		...
		public void run() {
			...
			firstIndex = Math.min(firstIndex, menuItemsArray.length - scrollCount);
			...
			boolean canScrollDown = firstIndex<menuItemsArray.length - scrollCount;
