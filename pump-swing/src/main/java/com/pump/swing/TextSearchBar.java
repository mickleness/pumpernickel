 ...
 * <table summary="Resource&#160;Samples&#160;for&#160;com.bric.swing.TextSearchBar">
 * <tr>
 * <td></td>
 * <td><img src=
 * "https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/TextSearchBar/Safari.png"
 * alt=
 * "com.bric.swing.TextSearchBar.createSafariStyleBar(new&#160;javax.swing.JTextArea())"
 * ></td>
 * <td><img src=
...
@ResourceSample(sample = {
		"com.bric.swing.TextSearchBar.createSafariStyleBar(new javax.swing.JTextArea())",
		"com.bric.swing.TextSearchBar.createFirefoxStyleBar(new javax.swing.JTextArea())" }, names = {
		"Safari", "Firefox" })
@Blurb(imageName = "TextSearch.png", title = "Text: Searching JTextComponents", releaseDate = "December 2009", summary = "This discusses different GUIs for the user to search for a string in a <code>JTextComponent</code>.\n"
		+ "<p>This includes the common search dialog, the model Safari uses and the model Firefox uses.", article = "http://javagraphics.blogspot.com/2009/12/text-searching-jtextcomponents.html")
