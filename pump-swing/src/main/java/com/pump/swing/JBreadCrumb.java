...
public class JBreadCrumb<T> extends JComponent {
	...
	public static interface BreadCrumbFormatter<T> {
		 ...
		 * 
		 * @param container
		 *            the <code>JBreadCrumb</code> this is part of.
		 * @param label
		 *            the label to be formatted.
		 * @param pathNode
		 *            the node/crumb being represented.
		 * @param index
	...
	public static final String FORMATTER_KEY = JBreadCrumb.class.getName()
			+ ".formatter";
	...
	public void updateUI() {
		if (UIManager.getDefaults().get(uiClassID) == null) {
			UIManager.getDefaults()
					.put(uiClassID, "com.pump.plaf.BreadCrumbUI");
		}
