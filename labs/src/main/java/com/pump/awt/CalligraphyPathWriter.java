...
import com.pump.geom.PathSegment;
import com.pump.geom.PathWriter;
import com.pump.geom.SimplifiedPathIterator;
...
public class CalligraphyPathWriter extends PathWriter {
	...
	public CalligraphyPathWriter(float angle, float offset1, float offset2,
		...
		this(angle, offset1, offset2, new Path2DWriter(destination),
				new Path2DWriter(destination));
	}
