...
public class TarEntry implements TarConstants {
    ...
    public TarEntry(String name, byte linkFlag) {
		...
		/** This constructor added by Jeremy Wood.
			* This lets you specify the path of a tar file.  For example, if you only wanted to
			* treat users/JoeSchmoe/Documents/x/y/z like "x/y/z", then you can.
			*/
