...
public class LocationBrowser extends JComponent {
	...
	public LocationBrowser(boolean allowMultipleSelection) {
		this(new IOSelectionModel(allowMultipleSelection), new LocationHistory(), new GraphicCache());
	}
	...
	public void updateUI() {
    	if(UIManager.getDefaults().get(uiClassID)==null) {
    		UIManager.getDefaults().put(uiClassID, "com.pump.plaf.ListLocationBrowserUI");
    	}
