...
public interface MissingJarResponseManager {
	 ...
	 * <p>
	 * If <code>getBehavior()</code> has already returned <code>null</code> then
	 * we're going to show a dialog to the user to make them decide. But this
	 * method helps prepopulate the choices. If the user likes what they see,
	 * they can just hit the return key and move on.
	 * <p>
	 * This method may consult other projects and see if they have already
	 * stored a Behavior for this file.
	 * 
	 * @param jarFile
	 *            the file to guess the Behavior for.
	 * @return a reasonable guess at the Behavior to associate with this File,
	 *         or null.
	 */
	 ...
	 * 
	 * @param file
	 *            the file to fetch the Behavior for.
	 * @param knownDependency
	 *            if true then we know for certain that this file is needed. If
	 *            false then we're not sure if this file is required.
	 * @return the last Behavior assigned to this File. This may return null if
	 ...
	 * 
	 * @param file
	 *            the file to assign the Behavior for.
	 * @param b
	 *            the Behavior this file should use.
	 */
