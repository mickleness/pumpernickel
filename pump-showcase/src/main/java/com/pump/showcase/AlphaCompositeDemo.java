 ...
 * alt="new&#160;com.bric.awt.CompositeDemo()"> <!-- ======== END OF
...
public class AlphaCompositeDemo extends JPanel {
	...
	class CompositePreview extends JPanel {
		...
		BufferedImage image1 = new BufferedImage(300, 200,
				BufferedImage.TYPE_INT_ARGB);
		BufferedImage image2 = new BufferedImage(300, 200,
				BufferedImage.TYPE_INT_ARGB);
		...
		public CompositePreview() {
			...
			BufferedImage checkers = new BufferedImage(100, 100,
			...
			g.fillRect(checkers.getWidth() / 2, checkers.getHeight() / 2,
					checkers.getWidth() / 2, checkers.getHeight() / 2);
			g.dispose();
			checkerboard = new TexturePaint(checkers, new Rectangle(0, 0,
					checkers.getWidth(), checkers.getHeight()));
		}
		...
		protected void paintComponent(Graphics g0) {
			...
			Paint destPaint = new GradientPaint(0, 0, new Color(255, 100, 100,
					0), 0, 200, new Color(255, 100, 100, destAlpha));
			...
			Paint srcPaint = new GradientPaint(0, 200, new Color(100, 100, 255,
					0), 0, 0, new Color(100, 100, 255, sa));
			if (useImages.isSelected()) {
			...
			g.translate(getWidth() / 2 - bounds.width / 2, getHeight() / 2
					- bounds.height / 2);
