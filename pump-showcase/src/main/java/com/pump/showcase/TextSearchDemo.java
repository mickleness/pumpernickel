 ...
 * <p>
 * <img src=
 * "https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/TextSearchDemo/sample.png"
 * alt="new&#160;com.bric.swing.TextSearchDemo()"> <!-- ======== END OF
...
public class TextSearchDemo extends JPanel {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == firefoxButton) {
				...
				UIManager.put("textSearchHighlightEffect",
						"com.bric.plaf.AquaSearchHighlight");
			} else if (e.getSource() == firefoxEffect) {
				UIManager.put("textSearchHighlightEffect",
						"com.bric.plaf.FirefoxSearchHighlight");
			} else if (e.getSource() == nudgeEffect) {
				UIManager.put("textSearchHighlightEffect",
						"com.bric.plaf.NudgeSearchHighlight");
			}
		}
	};
	...
	public TextSearchDemo() {
		try {
			text = new JEditorPane(TextSearchDemo.class.getResource("book.htm"));
		} catch (Exception e) {
			e.printStackTrace();
