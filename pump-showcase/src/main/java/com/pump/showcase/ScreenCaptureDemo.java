 ...
 * <p><img src="https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/samples/ScreenCaptureDemo/sample.png" alt="new&#160;com.bric.capture.ScreenCaptureDemo()">
	...
	public ScreenCaptureDemo(JFrame frame) {
		...
		recordButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(capture==null) {
					try {
						capture = new RobotScreenCapture(ScreenCaptureDemo.this.frame.getBounds());
						capture.start();
