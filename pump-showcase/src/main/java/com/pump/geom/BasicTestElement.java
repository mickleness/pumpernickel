...
public abstract class BasicTestElement extends TestElement {
	...
	public synchronized static boolean equals(Shape s1,Shape s2,PrintStream printStream) {
	 ...
	 * @param bi2
	 */
	public static boolean equals(BufferedImage bi1,BufferedImage bi2,PrintStream printStream) {
										...
										if(errors.contains(p2)) {
											...
											if(errors.contains(p2)) {
												try {
													...
													printStream.println("\tx = "+p.x+", y = "+p.y);
													printStream.println("\t"+f1.getAbsolutePath());
													printStream.println("\t"+f2.getAbsolutePath());
												} catch(Exception e) {
													e.printStackTrace();
												}
												return false;
