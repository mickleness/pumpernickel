...
public class MarkerRuleTest extends TestCase {
	...
	public void testOneCount() {
		assertEquals(0, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"00000000", 2)));

		assertEquals(1, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"00000001", 2)));
		assertEquals(1, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"00000010", 2)));
		assertEquals(1, MarkerRule.OneCount.getOneCount(Integer.parseInt(
		...
		assertEquals(2, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"00000011", 2)));
		assertEquals(2, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"00001010", 2)));
		assertEquals(2, MarkerRule.OneCount.getOneCount(Integer.parseInt(
		...
		assertEquals(8, MarkerRule.OneCount.getOneCount(Integer.parseInt(
				"11111111", 2)));
	}
