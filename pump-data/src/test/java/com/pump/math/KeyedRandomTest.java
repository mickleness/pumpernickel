...
public class KeyedRandomTest extends TestCase implements TestingStrings {
	...
	/** This makes sure a KeyedRandom is distributing random doubles relatively equally.
	 * 
	 */
	public void testDistribution() {
		...
		testDistribution( new KeyedRandom("Is it better to have loved and lost than never to have loved at all?") );
	}
	...
	private void testDistribution(KeyedRandom random) {
		...
		assertTrue("standard deviation ("+stdDev+") is too high", sqrt<2000);
	}
