...
article = "http://javagraphics.blogspot.com/2014/11/text-handwriting-text-effect.html"
)
public class WritingFont {
	...
	public static WritingFont CALLIGRAPHY = getFont( WritingFont.class.getResource("Calligraphy.writtenfont") );
	
	/** A WritingFont that resembles the public domain font <a href="http://comicneue.com/">Comic Neue</a> */
	public static WritingFont COMIC_NEUE = getFont( WritingFont.class.getResource("ComicNeue.writtenfont") );
