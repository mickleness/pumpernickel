...
/**
 * <img src=
 * "https://raw.githubusercontent.com/mickleness/pumpernickel/master/pump-release/resources/filledbuttonui/CapsuleButtonUI.png"
 * alt="CapsuleButtonUI Screenshot">
 */
public class CapsuleButtonUI extends QButtonUI {
	...
	public static final SimpleButtonFill CAPSULE_FILL = new SimpleButtonFill() {
		...
		private Color[] normalColors = new Color[] { new Color(210, 210, 210),
				new Color(210, 210, 210), new Color(204, 204, 204),
				new Color(188, 188, 188), new Color(213, 213, 213) };
		private Color[] darkerColors = new Color[] { new Color(170, 170, 170),
				new Color(166, 166, 166), new Color(157, 157, 157),
				new Color(122, 122, 122), new Color(185, 185, 185)

		};
		private Color[] rolloverColors = new Color[] {
				new Color(192, 192, 192), new Color(186, 186, 186),
				new Color(179, 179, 179), new Color(158, 158, 158),
		...
		public Paint getRolloverFill(Rectangle fillRect) {
			return PlafPaintUtils.getVerticalGradient("capsuleUI.rollover",
					fillRect.height, fillRect.y, fillWeights, rolloverColors);
		}
	...
	public static final ButtonShape CAPSULE_SHAPE = new ButtonShape(8,
			Short.MAX_VALUE);
	 ...
	 * by invoking: <br>
	 * <code>UIManager.getDefaults().put("ButtonUI", "com.pump.plaf.CapsuleButtonUI");</code>
	 */
