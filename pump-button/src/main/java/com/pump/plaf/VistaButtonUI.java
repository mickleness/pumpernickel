...
public class VistaButtonUI extends FilledButtonUI {
	...
	private static final SimpleButtonFill VISTA_FILL = new SimpleButtonFill() {
		...
		final Color[] normalColors = new Color[] { Color.white, Color.white,
				new Color(235, 235, 235), new Color(221, 221, 221),
				new Color(207, 207, 207) };
		final Color[] rolloverColors = new Color[] { new Color(234, 246, 253),
				new Color(234, 246, 253), new Color(217, 240, 252),
				new Color(190, 230, 252), new Color(167, 217, 245) };
		final Color[] pressedColors = new Color[] { new Color(229, 244, 252),
				new Color(211, 236, 249), new Color(196, 229, 246),
				new Color(152, 209, 239), new Color(104, 179, 219) };
		...
		public Paint getDarkerFill(Rectangle fillRect) {
			return PlafPaintUtils.getVerticalGradient("vista.darker",
					fillRect.height, fillRect.y, weights, pressedColors);
		}
		...
		public Paint getRolloverFill(Rectangle fillRect) {
			return PlafPaintUtils.getVerticalGradient("vista.rollover",
					fillRect.height, fillRect.y, weights, rolloverColors);
		}
	 ...
	 * by invoking: <br>
	 * <code>UIManager.getDefaults().put("ButtonUI", "com.pump.plaf.VistaButtonUI");</code>
	 */
	...
	public void paintStroke(Graphics2D g, ButtonInfo info) {
		if (isStrokePainted(info.button)) {
			...
			if (info.button.getModel().isSelected()
