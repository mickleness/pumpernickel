 ...
 */
 @Blurb (
title = "Jars: Autogenerating Java Source Code From Class Objects",
releaseDate = "January 2017",
summary = "The x-ray project creates source code that matches the method and field signatures of existing <code>java.lang.Class</code> objects. The methods are all empty, and most of the fields are null, but the resulting jar is something that 3rd parties can at least compile against."
)
