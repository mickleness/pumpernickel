...
/**
 * This writer is responsible for one Class object (which can be a "class", "interface"
 * or "enum").
 * <p>
 * This class will write a "hollow" or "empty" java source code file that resembles
 * signatures from a java.lang.Class object. (The moniker "mock object" has a special meaning,
 * and it's not really appropriate to call this a mock object.)
 */
public class ClassWriter extends StreamWriter {
	...
	/** If true a small block of javadoc is added to the topmost declaration in this file
	 * that explains that the origin of the autogenerated code.
	 */
	 ...
	 * 
	 * @param type the class this ClassWriter will mock/fake.
	 * @param autopopulate if true then {@link #autopopulate()} is called to
	 * build a reasonable set of basic fields/constructors/members.
	 */
	 ...
	 * 
	 * @param sourceCodeManager the optional SourceCodeManager that is used to index
	 * dependencies that this ClassWriter identifies. For example if representing
	 * the class <code>java.lang.Thread</code> requires the method <code>java.util.Map</code>,
	 * then that method will be added to the sourceCodeManager when this object writes data.
	 * @param type the class this ClassWriter will mock/fake.
	 * @param autopopulate if true then {@link #autopopulate()} is called to
	 * build a reasonable set of basic fields/constructors/members.
	 */
	 ...
	 * ClassWriter emulates. Generally this grabs non-private elements,
	 ...
	 * 
	 * @param nameToSimpleName a map of full classnames to simple class names (such as "java.lang.Thread" to "Thread")
	 * @param writer the writer used to populate the map.
	 */
	...
	/**
	 * Write a class or interface body (member declarations, fields, constructors, methods)
	 * 
	 * @param cws the stream to write to.
	 */
	...
	/**
	 * Write an enum body (enum constants, fields, methods). Constructors
	 * are omitted, because 3rd parties will never need to construct an enum.
	 * 
	 * @param cws the stream to write to.
	 */
	...
	/** Return the ClassWriter associated with a declared (member/nested) type, or null if no ClassWriter is identified. */
	...
	/** Return true if the javadoc-enabled flag is active. If this is true then the topmost declaration in this ClassWriter
	 * will receive a small javadoc explanation of how this code was autogenerated. */
