 ...
 * 
 */
@Blurb(title = "Strokes: a Bristle Stroke", releaseDate = "May 2008", summary = "A stroke based on splattering lots of tiny shapes along a path.", article = "http://javagraphics.blogspot.com/2008/05/strokes-bristle-stroke.html", imageName = "BristleStroke.png")
