 ...
 * <code>g.setStroke(getStroke());</code> <br>
 * <code>g.setPaint(getStrokePaint());</code> <br>
 * <code>g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,opacity));</code>
 * <br>
 * <code>g.draw(getShape());</code>
 * 
 **/
public interface DrawInstruction extends GraphicInstruction {
	...
	/**
	 * Returns the optional clipping. This is <i>not</i> relative to the
