...
/**
 * This simply records the baselines that text is drawn at. These values are
 * stored as Integers in the <code>baselines</code> field of this object.
 */
public class BaselineGraphics2D extends AbstractGraphics2D {
	 ...
	 * <p>
	 * This class is very basic, and a baseline is recorded whether or not it
	 * falls inside the clipped area. Also rotated baselines are not recorded,
	 * because, well, they make things complicated.
	 * 
