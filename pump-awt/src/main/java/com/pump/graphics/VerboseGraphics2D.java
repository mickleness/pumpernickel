...
public class VerboseGraphics2D extends Graphics2D {
	...
	public void clearRect(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "clearRect(" + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void clipRect(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "clipRect( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void copyArea(int x, int y, int width, int height, int dx, int dy) {
		if (output) {
			System.out.println(i() + "copyArea( " + x + ", " + y + ", " + width
					+ ", " + height + ", " + dx + ", " + dy + " )");
		}
		indent++;
		try {
	...
	public Graphics create(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "create( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
			return new VerboseGraphics2D((Graphics2D) g.create(x, y, width,
					height), output);
		} finally {
			indent--;
		}
	...
	public void draw3DRect(int x, int y, int width, int height, boolean raised) {
		if (output) {
			System.out.println(i() + "draw3DRect( " + x + ", " + y + ", "
					+ width + ", " + height + ", " + raised + " )");
		}
		indent++;
		try {
	...
	public void drawArc(int x, int y, int width, int height, int startAngle,
			int arcAngle) {
		if (output) {
			System.out.println(i() + "drawArc( " + x + ", " + y + ", " + width
	...
	public void drawBytes(byte[] data, int offset, int length, int x, int y) {
		if (output) {
			System.out.println(i() + "drawBytes( " + s(data) + ", " + offset
					+ ", " + length + ", " + x + ", " + y + " )");
		}
		indent++;
		try {
	...
	public void drawChars(char[] data, int offset, int length, int x, int y) {
		if (output) {
			System.out.println(i() + "drawChars( " + s(data) + ", " + offset
					+ ", " + length + ", " + x + ", " + y + " )");
		}
		indent++;
		try {
	...
	public void drawImage(BufferedImage img, BufferedImageOp op, int x, int y) {
		if (output) {
			System.out.println(i() + "drawImage( bi, " + op + ", " + x + ", "
					+ y + " )");
		}
		indent++;
		try {
	...
	public boolean drawImage(Image img, int x, int y, Color bgcolor,
		...
		if (output) {
			System.out.println(i() + "drawImage( img, " + x + ", " + y + ", "
					+ bgcolor + ", obs )");
		}
		indent++;
		try {
	...
	public boolean drawImage(Image img, int x, int y, int width, int height,
		...
		indent++;
		try {
			boolean returnValue = g.drawImage(img, x, y, width, height,
					bgcolor, observer);
			System.out.println(i() + " = " + returnValue);
			return returnValue;
		} finally {
	...
	public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2,
			...
			ImageObserver observer) {
		if (output) {
			System.out.println(i() + "drawImage( img, " + dx1 + ", " + dy1
					+ ", " + dx2 + ", " + dy2 + ", " + sx1 + ", " + sy1 + ", "
					+ sx2 + ", " + sy2 + ", " + bgcolor + ", observer )");
		}
		indent++;
		try {
			boolean returnValue = g.drawImage(img, dx1, dy1, dx2, dy2, sx1,
	...
	public void drawLine(int x1, int y1, int x2, int y2) {
		if (output) {
			System.out.println(i() + "drawLine( " + x1 + ", " + y1 + ", " + x2
					+ ", " + y2 + " )");
		}
		indent++;
		try {
	...
	public void drawOval(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "drawOval( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void drawRect(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "drawRect( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void drawRoundRect(int x, int y, int width, int height,
		...
		if (output) {
			System.out.println(i() + "drawRoundRect( " + x + ", " + y + ", "
					+ width + ", " + height + ", " + arcWidth + ", "
					+ arcHeight + " )");
		}
		indent++;
		try {
	...
	public void drawString(AttributedCharacterIterator iterator, float x,
			float y) {
		if (output) {
			System.out.println(i() + "drawString( " + s(iterator) + ", " + x
					+ ", " + y + " )");
		}
		indent++;
		try {
	...
	public void drawString(String s, float x, float y) {
		if (output) {
			System.out.println(i() + "drawString( \"" + s + "\", " + x + ", "
					+ y + " )");
		}
		indent++;
		try {
	...
	public void drawString(String str, int x, int y) {
		if (output) {
			System.out.println(i() + "drawString( \"" + str + "\", " + x + ", "
					+ y + " )");
		}
		indent++;
		try {
	...
	public void fill3DRect(int x, int y, int width, int height, boolean raised) {
		if (output) {
			System.out.println(i() + "fill3DRect( " + x + ", " + y + ", "
					+ width + ", " + height + ", " + raised + " )");
		}
		indent++;
		try {
	...
	public void fillArc(int x, int y, int width, int height, int startAngle,
			int arcAngle) {
		if (output) {
			System.out.println(i() + "fillArc( " + x + ", " + y + ", " + width
					+ ", " + height + ", " + startAngle + ", " + arcAngle
					+ " )");
		}
		indent++;
	...
	public void fillOval(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "fillOval( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void fillRect(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "fillRect( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void fillRoundRect(int x, int y, int width, int height,
			int arcWidth, int arcHeight) {
		if (output) {
			System.out.println(i() + "fillRoundRect( " + x + ", " + y + ", "
					+ width + ", " + height + ", " + arcWidth + ", "
					+ arcHeight + " )");
		}
		indent++;
	...
	public boolean hit(Rectangle rect, Shape s, boolean onStroke) {
		if (output) {
			System.out.println(i() + "hit( " + rect + ", " + s(s) + ", "
					+ onStroke + " )");
		}
		indent++;
		try {
	...
	public boolean hitClip(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "hitClip( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void setClip(int x, int y, int width, int height) {
		if (output) {
			System.out.println(i() + "setClip( " + x + ", " + y + ", " + width
					+ ", " + height + " )");
		}
		indent++;
		try {
	...
	public void setRenderingHint(Key hintKey, Object hintValue) {
		if (output) {
			System.out.println(i() + "setRenderingHint( " + hintKey + ", "
					+ hintValue + " )");
		}
		indent++;
		try {
