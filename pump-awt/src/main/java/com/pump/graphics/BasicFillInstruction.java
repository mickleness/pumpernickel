...
public class BasicFillInstruction implements FillInstruction, Serializable {
	 ...
	 *            the shape to fill.
	 * @param transform
	 *            the transform to view the shape through.
	 * @param clipping
	 ...
	 *            the opacity.
	 */
	public BasicFillInstruction(Shape shape, AffineTransform transform,
			Shape clipping, Paint p, float opacity) {
	...
	/**
	 * Returns the <code>AffineTransform</code> this shape is viewed through.
	 */
	 ...
	 * 
	 * @param includeTransform
	 *            whether to transform the shape.
	 * @param includeClipping
	 *            whether to clip the shape, if a clipping is provided.
