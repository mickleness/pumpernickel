 ...
 * This class is strongly related to the <code>QDialog</code> project,
 ...
 * platforms the help component is a {@link com.pump.swing.JLink}.</li>
...
public class DialogFooter extends JPanel {
	...
	public static JButton createDontSaveButton(boolean escapeKeyIsTrigger) {
		...
		button.putClientProperty(DialogFooter.PROPERTY_META_SHORTCUT,
				Character.valueOf(text.charAt(0)));
		if (escapeKeyIsTrigger)
			makeEscapeKeyActivate(button);
		return button;
	}
