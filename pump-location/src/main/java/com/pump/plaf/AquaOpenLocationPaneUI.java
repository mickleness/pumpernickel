...
public class AquaOpenLocationPaneUI extends OpenLocationPaneUI {
	public static final String KEY_INCLUDE_SIDEBAR = AquaOpenLocationPaneUI.class.getName()+"#includeSidebar";
	public static final String KEY_INCLUDE_FOOTER = AquaOpenLocationPaneUI.class.getName()+"#includeFooter";
	...
	protected void installGUI(JComponent panel) {
		panel.addPropertyChangeListener(KEY_INCLUDE_SIDEBAR, propertyChangeListener);
		...
		boolean includeSidebar = getBoolean(locationPane, KEY_INCLUDE_SIDEBAR, true);
		boolean includeFooter = getBoolean(locationPane, KEY_INCLUDE_FOOTER, true);
	...
	private boolean getBoolean(JComponent jc,
	...
	public void uninstallUI(JComponent c) {
		c.removePropertyChangeListener(KEY_INCLUDE_SIDEBAR, propertyChangeListener);
		super.uninstallUI(c);
	}
