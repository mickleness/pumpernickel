...
public class ZoomTransition2D extends AbstractPlanarTransition2D {
	...
	public static Transition[] getDemoTransitions() {
		return new Transition[] { new ZoomTransition2D(Transition.LEFT, false),
				new ZoomTransition2D(Transition.LEFT, true),
				new ZoomTransition2D(Transition.RIGHT, false),
				new ZoomTransition2D(Transition.RIGHT, true) };
	}
