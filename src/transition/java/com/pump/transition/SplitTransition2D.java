...
public class SplitTransition2D extends Transition2D {
	...
	public static Transition[] getDemoTransitions() {
		return new Transition[] { new SplitTransition2D(Transition.HORIZONTAL, false),
				new SplitTransition2D(Transition.HORIZONTAL, true),
				new SplitTransition2D(Transition.VERTICAL, false),
				new SplitTransition2D(Transition.VERTICAL, true) };
	}
	...
	public SplitTransition2D() {
		this(Transition.HORIZONTAL, false);
	}
	...
	public String toString() {
		if (in && type == Transition.HORIZONTAL) {
			return "Split Horizontal In";
		} else if (type == Transition.HORIZONTAL) {
			return "Split Horizontal Out";
		} else if (in && type == Transition.VERTICAL) {
