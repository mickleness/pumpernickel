...
/**
 * This block represents a range of different IDs that all begin with the "©"
 * character.
 * <p>
 ...
 * different languages.
 * <p>
 * The list of text strings uses a small integer block format, which is
 * identical to the QuickTime block format except that it uses 16-bit values for
 * size and type instead of 32-bit values. The first value is the size of the
 * string, including the size and type, and the second value is the language
 * code for the string.
 * <p>
 ...
 * @see TextTypes
 */
public class UserDataTextBlock extends LeafBlock {
	...
	public UserDataTextBlock(Block parent, String blockType,
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("UserDataTextBlock[ \""
				+ getBlockType() + "\" ");
		for (int a = 0; a < entries.size(); a++) {
			TextEntry e = entries.get(a);
