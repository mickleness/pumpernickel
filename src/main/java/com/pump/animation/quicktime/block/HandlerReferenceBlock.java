...
/**
 * The handler reference block specifies the media handler component that is to
 * be used to interpret the media’s data. The handler reference block has an
 * block type value of 'hdlr'.
 * <p>
 * Historically, the handler reference block was also used for data references.
 * However, this use is no longer current and may now be safely ignored.
 * <p>
 * The handler block within a media block declares the process by which the
 * media data in the stream may be presented, and thus, the nature of the media
 * in a stream. For example, a video handler would handle a video track.
 */
public class HandlerReferenceBlock extends LeafBlock {

	public static final String BLOCK_TYPE = "hdlr";
	...
	public HandlerReferenceBlock(String componentType, String componentSubtype,
	...
	public HandlerReferenceBlock(Block parent, GuardedInputStream in)
			throws IOException {
		super(parent);
	...
	public String toString() {
		return "HandlerReferenceBlock[ version=" + version + ", " + "flags="
