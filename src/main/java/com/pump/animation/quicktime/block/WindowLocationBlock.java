 ...
 */
public class WindowLocationBlock extends LeafBlock {
	/** "WLOC" */
	public static final String BLOCK_TYPE = "WLOC";

	protected int x, y;

	public WindowLocationBlock(Block parent, InputStream in) throws IOException {
		super(parent);
		x = read16Int(in);
		y = read16Int(in);
	}
