...
/**
 * Video media information header blocks define specific color and graphics mode
 * information.
 */
public class VideoMediaInformationHeaderBlock extends LeafBlock {

	/** "vmhd" */
	public static final String BLOCK_TYPE = "vmhd";
	...
	public VideoMediaInformationHeaderBlock() {
		super(null);
	}

	public VideoMediaInformationHeaderBlock(Block parent, InputStream in)
			throws IOException {
		super(parent);
		version = in.read();
		flags = read24Int(in);
	...
	public String toString() {
		return "VideoMediaInformationHeaderBlock[ version=" + version + ", "
