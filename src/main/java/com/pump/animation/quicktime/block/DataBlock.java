...
/**
 * This is a "data" block based on the mp4 specifications.
 */
public class DataBlock extends LeafBlock {

	public static final String BLOCK_TYPE = "data";
	...
	public DataBlock(Block parent, GuardedInputStream in) throws IOException {
		super(parent);
	...
	/**
	 * If this data block represents text, then this returns that text as a
