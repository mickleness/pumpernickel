...
public class MissingJarPreferenceResponseManager implements
		MissingJarResponseManager {
	 ...
	 * 
	 * @param name
	 *            the project name, which is used to distinguish the preferences
	 *            so different projects can make different choices.
	 */
	...
	@Override
	public MissingJarResponse getBehavior(File file,
			boolean applyToNonrequiredJars) {
	...
	private void catalogPrefs(Preferences prefs, File jarFile,
			Map<String, Integer> results) throws BackingStoreException {
