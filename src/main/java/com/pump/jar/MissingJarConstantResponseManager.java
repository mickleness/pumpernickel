 ...
 */
public class MissingJarConstantResponseManager implements
	 ...
	 * 
	 * @param b
	 *            the fixed MissingJarResponse this choice always uses.
	 */
	public MissingJarConstantResponseManager(MissingJarResponse b,
	...
	/**
	 * This throws an exception if the argument b is not the Behavior passed to
	...
	public void setBehavior(File file, MissingJarResponse b) {
		if (!behavior.equals(b))
			throw new RuntimeException(
					"this operation is not supported for a fixed behavior");
	}
