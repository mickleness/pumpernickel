...
public class IOUtils {
	 ...
	 * <p>
	 * This can read data created via {@link #serialize(Serializable, OutputStream, boolean)}.
	 *
	...
	public static byte[] serialize(Serializable serializable) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream()) {
			serialize(serializable, byteOut, true);
	...
	/**
	 * Deserialized a compressed byte array created via {@link #serialize(Serializable)}.
	 *
	 ...
	 */
	public static void serialize(Serializable object, OutputStream outputStream, boolean useGZIPcompression) throws IOException {
		if (useGZIPcompression) {
			try (GZIPOutputStream zipOut = new GZIPOutputStream(outputStream)) {
