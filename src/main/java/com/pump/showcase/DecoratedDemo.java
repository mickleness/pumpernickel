 ...
 */
public class DecoratedDemo implements ShowcaseDemo {
	static class DecoratedDemoPanel extends JPanel {
		...
		static class PulsingDecoration extends RepaintingDecoration {
			...
			public Icon getIcon(JTree tree, Object value, boolean selected,
					...
					boolean isRollover, boolean isPressed) {
				return pulse(super.getIcon(tree, value, selected, expanded,
						leaf, row, isRollover, isPressed));
			}
		...
		static class PlayPauseDecoration implements TreeDecoration,
				ListDecoration {
			...
			public Point getLocation(JList list, Object value, int row,
				...
				return new Point(r.x + r.width - icon.getIconWidth(),
						list.getFixedCellHeight() / 2 - icon.getIconHeight()
								/ 2);
			}
		}
		...
		static class StarDecoration implements ListTreeDecoration {
			...
			ActionListener actionListener = new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					component.putClientProperty(PROPERTY_STAR_COUNT,
							myStarIndex);
				}
			};
			int myStarIndex;
		...
		abstract static class AbstractDemo<T extends JComponent> extends JPanel {
			...
			BasicDecoration closeDecoration = new BasicDecoration(
					new PaddedIcon(new CloseIcon(12), ICON_INSETS),
					new PaddedIcon(new CloseIcon(12, CloseIcon.State.ROLLOVER),
							ICON_INSETS), new PaddedIcon(new CloseIcon(12,
				...
				public boolean isVisible(JTree tree, Object value,
					...
					return super.isVisible(tree, value, selected, expanded,
							leaf, row, hasFocus) && isVisible(value);
				}
			...
			PulsingDecoration warningDecoration = new PulsingDecoration(
					new BasicDecoration(new PaddedIcon(WARNING_ICON,
							ICON_INSETS)) {
						@Override
						public boolean isVisible(JTree tree, Object value,
							...
							return super.isVisible(tree, value, selected,
									expanded, leaf, row, hasFocus)
									&& NAME_WARNING.equals(name);
						}

						@Override
						public boolean isVisible(JList list, Object value,
								int row, boolean isSelected,
								boolean cellHasFocus) {
							return super.isVisible(list, value, row,
									isSelected, cellHasFocus)
									&& NAME_WARNING.equals(value);
						}
					}, 50);
			...
			BasicDecoration refreshDecoration = new BasicDecoration(
					new PaddedIcon(new RefreshIcon(14, Color.gray), ICON_INSETS),
					new PaddedIcon(new RefreshIcon(14, Color.darkGray),
							ICON_INSETS), new PaddedIcon(new RefreshIcon(14,
							Color.white), ICON_INSETS), new ActionListener() {
						public void actionPerformed(ActionEvent e) {
		...
		static class ListDemo extends AbstractDemo<JList<String>> {
			...
			public ListDemo() {
				...
				getDecoratedComponent().putClientProperty(
						...
						new ListDecoration[] { progressDecoration,
								starDecoration1, starDecoration2,
								starDecoration3, starDecoration4,
				...
				getDecoratedComponent().setPreferredSize(
		...
		static class TreeDemo extends AbstractDemo<JTree> {
			...
			JCheckBox stretchHighlight = new JCheckBox("Stretch Highlight",
					true);

			public TreeDemo() {
				getDecoratedComponent().putClientProperty(
						DecoratedTreeUI.KEY_DECORATIONS,
						new TreeDecoration[] { progressDecoration,
								starDecoration1, starDecoration2,
								starDecoration3, starDecoration4,
								starDecoration5, closeDecoration,
								playPauseDecoration, warningDecoration,
				...
				stretchHighlight.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						getDecoratedComponent().setUI(
								new DecoratedTreeUI(stretchHighlight
										.isSelected()));
					}
				});
