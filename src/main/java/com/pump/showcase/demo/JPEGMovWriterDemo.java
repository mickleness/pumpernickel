...
/**
 * A minimal UI that creates .mov files using the JPEGMovWriter classes.
 * 
 * <a href=
 ...
 */
public class JPEGMovWriterDemo extends ShowcaseDemo {
	...
	JSpinner framesSpinner = new JSpinner(
			new SpinnerNumberModel(100, 1, 1_000_000, 10));
	...
	public void export() {
		...
		try {
			...
			for (; framesWritten < frameCount; framesWritten++) {
				...
				anim.addFrame(frameDuration, bi, quality);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
    ...
    public String getSummary() {
        return "The MovWriter class can create a poorly compressed .mov file based on JPEG image frames and uncompressed WAV audio.";
    }
    ...
    public String[] getKeywords() {
        return new String[] {"QuickTime", "mov", "animation", "JPEG", "JPG", "WAV"};
    }

    @Override
    public Class<?>[] getClasses() {
        return new Class[] { JPEGMovWriter.class };
    }
}