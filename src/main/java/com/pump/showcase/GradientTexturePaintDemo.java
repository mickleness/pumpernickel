 ...
 */
public class GradientTexturePaintDemo implements ShowcaseDemo {
	static class GradientTexturePaintDemoPanel extends JPanel {
			...
			protected void paintComponent(Graphics g0) {
						...
						BufferedImage.TYPE_INT_ARGB);
				{
					...
					if (typeComboBox.getSelectedItem() == GradientType.GRADIENT_TEXTURE_PAINT) {
						...
						p = new LinearGradientPaint(p1, p2,
		...
		public GradientTexturePaintDemoPanel() {
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new GradientTexturePaintDemoPanel();
	}
