 ...
 */
public class XMLTextComponentHighlighterDemo implements ShowcaseDemo {
	static class XMLTextComponentHighlighterDemoPanel extends JPanel {
		...
		public XMLTextComponentHighlighterDemoPanel() {
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new XMLTextComponentHighlighterDemoPanel();
	}
