 ...
 *
 */
public class BoxTabbedPaneUIDemo implements ShowcaseDemo {

	static class BoxTabbedPaneUIDemoPanel extends JPanel {
		private static final long serialVersionUID = 1L;

		JTabbedPane tabs = new JTabbedPane();
		JButton addButton = new JButton(new PaddedIcon(new PlusIcon(12, 12, 1,
				null), new Dimension(22, 22)));
		...
		public BoxTabbedPaneUIDemoPanel() {
			...
			ActionListener closeableListener = new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					tabs.putClientProperty(
							BoxTabbedPaneUI.PROPERTY_CLOSEABLE_TABS,
			...
			addButton.setBorder(new PartialLineBorder(Color.gray, new Insets(1,
					0, 1, 1)));
			...
			tabs.putClientProperty(
					BoxTabbedPaneUI.PROPERTY_TRAILING_COMPONENTS,
					Arrays.asList(addButton));

			addButton.setMargin(new Insets(0, 0, 0, 0));
			BoxTabbedPaneUI.getStyle(tabs).formatControlRowButton(tabs,
					addButton, -1);
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new BoxTabbedPaneUIDemoPanel();
	}
