 ...
 */
public class QPanelUIDemo implements ShowcaseDemo {

	static class QPanelUIDemoPanel extends JPanel {
		...
		JRadioButton orientationHorizontal = new JRadioButton("Horizontal",
				false);
		...
		public QPanelUIDemoPanel() {
			...
			layout.addRow(new JLabel("Callout Type:"), calloutTypeComboBox,
					false);
			...
			fillColor1.getColorSelectionModel().addChangeListener(
					changeListener);
			fillColor2.getColorSelectionModel().addChangeListener(
					changeListener);
			strokeColor1.getColorSelectionModel().addChangeListener(
					changeListener);
			strokeColor2.getColorSelectionModel().addChangeListener(
					changeListener);
		...
		protected void updateControlsForUI(QPanelUI ui) {
			fillColor1.getColorSelectionModel().setSelectedColor(
					ui.getFillColor1());
			fillColor2.getColorSelectionModel().setSelectedColor(
					ui.getFillColor2());
			...
			if (Objects.equals(ui.getFillColor1(), ui.getFillColor2())
					&& Objects.equals(ui.getStrokeColor1(),
							ui.getStrokeColor2())) {
		...
		/**
		 * Populate all the detalis of a QPanelUI based on the GUI controls in
		 * this demo.
		 */
		protected void updateUIFromControls(QPanelUI ui) {
			...
			ui.setCalloutType((CalloutType) calloutTypeComboBox
					.getSelectedItem());
