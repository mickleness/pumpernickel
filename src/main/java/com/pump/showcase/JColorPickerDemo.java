 ...
 *
 */
public class JColorPickerDemo implements ShowcaseDemo {
	static class JColorPickerDemoPanel extends JPanel {
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new JColorPickerDemoPanel();
	}
