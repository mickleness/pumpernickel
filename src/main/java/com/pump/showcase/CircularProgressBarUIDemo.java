 ...
 */
public class CircularProgressBarUIDemo implements ShowcaseDemo {
	static class CircularProgressBarUIDemoPanel extends JPanel {
		private static final long serialVersionUID = 1L;

		JPanel controls = new JPanel();
		JSlider sizeSlider = new JSlider(10, 120, 90);
		JRadioButton indeterminateButton = new JRadioButton("Indeterminate",
				false);
		JRadioButton determinateButton = new JRadioButton("Determinate", true);
		JProgressBar progressBar = new JProgressBar(0, 100);
		JSpinner progressSpinner = new JSpinner(new SpinnerNumberModel(0, 0,
				100, 5));
		...
		ActionListener animateListener = new ActionListener() {
			...
			/**
			 * This increments the progress bar until we reach 100%, then we
		...
		public CircularProgressBarUIDemoPanel() {
			...
			layout.addRow(new JLabel("Effects:"), pulseCheckBox,
					transitionCheckBox);
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new CircularProgressBarUIDemoPanel();
	}
