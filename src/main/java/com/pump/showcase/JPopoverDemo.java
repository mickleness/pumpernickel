 ...
 */
public class JPopoverDemo implements ShowcaseDemo {
	static class JPopoverDemoPanel extends JPanel {
		...
		public JPopoverDemoPanel() {
			...
			passwordPopover = new JPopover<JToolTip>(passwordField,
					new JToolTip(), false) {
			...
			fontPopover = new JPopover<JToolTip>(fontComboBox, new JToolTip(),
				...
				protected void doRefreshPopup() {
					getContents()
							.setFont((Font) fontComboBox.getSelectedItem());
				}
