 ...
 */
public class CollapsibleContainerDemo implements ShowcaseDemo {
	static class CollapsibleContainerDemoPanel extends JPanel {
		...
		public CollapsibleContainerDemoPanel() {
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new CollapsibleContainerDemoPanel();
	}
