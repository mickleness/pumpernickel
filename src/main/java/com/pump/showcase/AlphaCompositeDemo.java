 ...
 *      Which Does What?</a>
 */
public class AlphaCompositeDemo implements ShowcaseDemo {

	static class AlphaCompositeDemoPanel extends JPanel {
		...
		public AlphaCompositeDemoPanel() {
		...
		class CompositePreview extends JPanel {
			...
			private void drawString(Graphics2D g, String s, float centerX,
				...
				g.drawString(s, (float) (centerX - r.getWidth() / 2),
						centerY + 1f);
			...
			private BufferedImage createImageSample(int destAlphaValue,
				...
				g.drawImage(myBackground,
						getWidth() / 2 - myBackground.getWidth() / 2
								- myBackground.getWidth() / 4, getHeight() / 2
								- myBackground.getHeight() / 2, null);
				g.setComposite(getComposite());
				g.drawImage(myForeground,
						getWidth() / 2 - myForeground.getWidth() / 2
								+ myForeground.getWidth() / 4, getHeight() / 2
			...
			private BufferedImage createShapeSample(int destAlphaValue,
				...
				Paint destPaint = new GradientPaint(0, 0, new Color(255, 100,
						100, 0), 0, 200, new Color(255, 100, 100,
						destAlphaValue));
				g.setPaint(destPaint);
				g.fill(destShape);

				Paint srcPaint = new GradientPaint(0, 200, new Color(100, 100,
						255, 0), 0, 0, new Color(100, 100, 255, srcAlphaValue));
				g.setComposite(getComposite());
				g.setPaint(srcPaint);
				g.fill(srcShape);
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new AlphaCompositeDemoPanel();
	}
