 ...
 * 
 */
public class AWTMonitorDemo implements ShowcaseDemo {
	static class AWTMonitorDemoPanel extends JPanel {
				...
				public void AWTPanic(String applicationName) {
					if (blockingThread != null && stopThread) {
						...
						try {
							...
							// it back to life
							AWTMonitorDemoPanel.this.repaint();
						} catch (Exception e) {
						}
					}
				}
	...
	public JPanel createPanel(PumpernickelShowcaseApp psa) {
		return new AWTMonitorDemoPanel();
	}
