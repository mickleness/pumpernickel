...
/**
 * This synchronized one master control button with several subordinate buttons. If all of the subordinate buttons are selected: the master button is selected. If none of the subordinate buttons are selected: the master button is unselected. Otherwise the master button renders in a mixed state to indicate that the group is only partially selected.
 * <p>
 * If you interact with the master button you can toggle all subordinate buttons on/off.
 */
public class MixedCheckBoxButtonGroup {
	...
	public MixedCheckBoxButtonGroup(JCheckBox masterButton, JCheckBox... subordinateButtons) {
		...
		for(JCheckBox subordinateButton : subordinateButtons) {
			subordinateButton.getModel().addItemListener(subordinateButtonListener);
		}
