...
public class TexturedButtonUI extends QButtonUI {
	...
	public static final SimpleButtonFill TEXTURED_FILL = new SimpleButtonFill() {
		...
		private Color[] darkestColors = new Color[] { new Color(0xff3A3A3A),
				new Color(0xff494949) };

		private Color[] darkerColors = new Color[] { new Color(0xffAFAFAF),
	 ...
	 * by invoking: <br>
	 * <code>UIManager.getDefaults().put("ButtonUI", "com.pump.plaf.TexturedButtonUI");</code>
	 */
	...
	private static BasicStroke outline1 = new BasicStroke(9,
			BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
	private static BasicStroke outline2 = new BasicStroke(6,
			BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
	private static BasicStroke outline3 = new BasicStroke(3,
			BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
